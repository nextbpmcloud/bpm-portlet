 ...
 * @author JMcCrindle
 */
public class BPMTemplateFactory implements TemplateFactory {

    private static final org.apache.commons.logging.Log log = org.apache.commons.logging.LogFactory
            .getLog(BPMTemplateFactory.class);
    
    private Templates defaultTemplate;

    private String defaultTemplateSytemId;
    
    private Map<String, Templates> templateCache = Collections.synchronizedMap(new HashMap<String, Templates>());

    public BPMTemplateFactory() {
        defaultTemplateSytemId = getClass().getResource(
                "/xsl/default.xsl").toExternalForm();
